   ...
   //点击销货 退货  出现的
	...
	$('.g_l,.g_r').hover(function(){
	 ...
	 $('.g_l').click(function(){
	  ...
	  $('.chima ul li .x').click(function(){
			$(this).addClass('hover')
			})
		
	  $('.xuanye_dd dl dt').hover(function(){
		  var s = $(this).index();
		  $(this).addClass('hover').siblings().removeClass('hover');
		  })
		  
	  $('.xuanye_d dl dt').hover(function(){
		  var s = $(this).index();
		  $(this).addClass('hover').siblings().removeClass('hover');
		  })
		  
	 $('.xuanye_d1 dl dt').hover(function(){
		  var s = $(this).index();
		  $(this).addClass('hover').siblings().removeClass('hover');
		  })
	
	/* 衣服尺寸  鞋子尺寸  文胸尺寸 */
	$('.yifu_d ul li').click(function(){
		var dai_d = $(this).index();
		$(this).addClass('hover').siblings().removeClass('hover');
		$('.cen_yu').eq(dai_d).show().siblings().hide();
		})
	})
